...
XMLCSTR XMLNode::getVersion() { return _X("v2.34"); }
...
// for Microsoft Visual Studio 6.0 and Microsoft Visual Studio .NET and Borland C++ Builder 6.0
        ...
        double  xmltof(XMLCSTR t,double  v){ if (t&&(*t)) return _wtof(t); return v; }
    #else
...
// for gcc and CC
        ...
        // for CC
           ...
           double  xmltof(XMLCSTR t,double  v){ if (t) return wstof(t,NULL); return v; }
        #else
        // for gcc
           ...
           double  xmltof(XMLCSTR t,double  v){ if (t) return wcstof(t,NULL); return v; }
        #endif
        static inline XMLSTR xstrstr(XMLCSTR c1, XMLCSTR c2) { return (XMLSTR)wcsstr(c1,c2); }
        static inline XMLSTR xstrcpy(XMLSTR c1, XMLCSTR c2) { return (XMLSTR)wcscpy(c1,c2); }
